  ...
  if ($_POST) {
    if (empty($_POST['name']) || empty($_POST['email']) || empty($_POST['phone']) || empty($_POST['address']) || empty($_POST['password']) || strlen($_POST['password'])<4) {
      ...
      if (empty($_POST['email'])) {
        $emailError="Fill in email";
      }
      if (empty($_POST['phone'])) {
        $phError="Fill in phone";
      }
      if (empty($_POST['address'])) {
        $addError="Fill in address";
      }
      ...
      if ($user) {
        ...
        $pdostmt=$pdo->prepare("INSERT INTO users(name,email,phone,address,password)
		...
		<div class="container">
			<div class="row">
              ...
              <div class="col-md-12 form-group">
                ...
                style="<?php echo empty($phError) ? '' : 'border: 1px solid red'; ?>"
              ...
              <div class="col-md-12 form-group">
                ...
                style="<?php echo empty($addError) ? '' : 'border: 1px solid red'; ?>"
