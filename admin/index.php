        ...
        <div class="row">
          <div class="col-md-12">
            <div class="card">
              ...
              <div class="card-body">
                <div>
                  <a href="product_add.php" type="button" class="btn btn-success"><i class="fas fa-plus-square">Create New</i></a>
                </div>
                <br>
                      ...
                      ?>
                        <tr>
                          ...
                          <td>
                            <div class="btn-group">
                              <div class="container">
                                <a href="product_edit.php?id=<?php echo $value['id'] ?>" type="button" class="btn btn-outline-warning"><i class="far fa-edit"></i></a>
                              </div>
                              <div class="container">
